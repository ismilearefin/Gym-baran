...
const Programs = () => {
  return (
    <div className="my-[120px] grid justify-center px-6">
      {/* SEO */}
      <Head>
        <title>Programs that can be taken</title>
        <meta
          name="description"
      ...
      <div className="flex justify-center items-center">
        <h1 className="font-[Grotesque] text-[28px] lg:text-[46px] leading-10 lg:leading-[72px] text-left mb-[38px] lg:mb-[50px] font-bold lg:font-normal lg:w-[558px] lg:text-center">
