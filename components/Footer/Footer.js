...
const Footer = () => {
    return (
        <div className='lg:w-[1440px] lg:h-[448px] bg-[#1C3764] relative grid justify-center items-center'>
            <Image src='/Stroke.png' width={200} height={185} className='absolute top-0 left-0 z-10 hidden lg:block'></Image>
            <Image src='/Stroke.png' width={200} height={192} className='absolute bottom-0 right-0 opacity-80 hidden lg:block'></Image>
            <div className='lg:w-[1150px] flex lg:flex-row flex-col lg:justify-between p-6'>
                <div className='lg:w-1/2'>
                    ...
                    <p className='text-[18px] lg:leading-8 text-white opacity-60 my-[30px] lg:w-[300px]'>We take care of your health with regular and fun exercise</p>
