  ...
  return (
    <div className="lg:w-[1229px] mx-auto flex flex-col-reverse lg:grid lg:grid-cols-2 items-center px-6">
      ...
      <Head>
        ...
        <meta
          name="description"
          content="The body becomes sick because of rarely exercise"
        />
      ...
      <div className="text-[#262524] lg:ml-8 ">
        <h1 className="mb-8 font-[Grotesque] text-[28px] lg:text-[46px] leading-10 lg:leading-[73px] font-bold lg:font-normal">
          How it works?
        </h1>
