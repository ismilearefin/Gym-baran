...
const HeroSection = () => {
  return (
    ...
    {/* Responsive Navbar using dasyUI */}
        <Navbar></Navbar>
    {/* Hero Section Start Here */} 
        <div className="flex flex-col md:flex-row lg:gap-8 md:mt-[85px] md:h-[580px] px-6">
          <div className="lg:w-1/2 lg:ml-20 mt-12">
            <h1 className="font-[Grotesque] font-bold leading-10 lg:leading-[73px] text-[28px] lg:text-[56px] text-[#262524]">
              Healthy in side
              <br /> <span className="text-[#8382EB]">fresh</span> out side
            </h1>
            <p className="leading-7 lg:text-base text-[12px] my-6">
