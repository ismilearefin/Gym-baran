    ...
    return (
        <div className='lg:w-[1236px] rounded-[30px] bg-gradient-to-r from-[#6462F0] to-[#9190E9] p-7 lg:p-[85px] grid gap-10 lg:grid-cols-3 lg:justify-center my-[60px] lg:mx-auto mx-6'>
            <div className='flex'>
                ...
                <div className=''>
                    <p className='text-white text-[16px] lg:text-xl  mb-4 font-bold'>Get that 11 line<br/> in 30 days</p>
            ...
            <div className='flex'>
                ...
                <div className=''>
                    <p className='text-white text-[16px] lg:text-xl mb-4 font-bold'>14 Days<br/> sherd challenge</p>
                    <button className='flex items-center  text-white opacity-50'>Learn more <FaArrowRight className='hover:text-black ml-[52px]'></FaArrowRight></button>
                </div>
            </div>
            <div className='flex'>
                <div className='mr-[30px] bg-[url(/Rectangleicon.png)] w-[100px] h-[100px] rounded-[20px] grid justify-center items-center'>
                ...
                <div className=''>
                    <p className='text-white text-[16px] lg:text-xl  mb-4 font-bold'>Get flat belly<br/> in 30 days</p>
                    <button className='flex items-center gap-x-5 text-white opacity-50'>Learn more <FaArrowRight className='hover:text-black'></FaArrowRight></button>
                </div>
            </div>
        </div>
